...
score = 0
tiers = [tier_1, tier_2, tier_3, tier_4, tier_5, tier_6, tier_7, tier_8, tier_9, tier_10]
m = input("Pass: ")
while m == "":
    random_tier = random.choice(tiers)
    if random_tier in tiers:
        a = tiers.index(random_tier) + 1
    h = random.choice(random_tier)
    print(f'\nCzołg: [{h}]')
    f = int(input(f"Tier: "))
    if a == f:
        print("Well done")
