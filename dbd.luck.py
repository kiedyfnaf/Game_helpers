...
if a == 'kil':
    ...
    if v == 'Trapper':
        print(f'Add-ons: {random.sample(Trapper, 2)}')
    elif v == 'Wraith':
        print(f'Add-ons: {random.sample(Wraith, 2)}')
    elif v == 'Nurse':
        print(f'Add-ons: {random.sample(Nurse, 2)}')
    elif v == 'Shape':
        print(f'Add-ons: {random.sample(Shape, 2)}')
    elif v == 'Hag':
        print(f'Add-ons: {random.sample(Hag, 2)}')
    elif v == 'Doctor':
        print(f'Add-ons: {random.sample(Doctor, 2)}')
    elif v == 'Huntress':
        print(f'Add-ons: {random.sample(Huntress, 2)}')
    elif v == 'Nightmare':
        print(f'Add-ons: {random.sample(Nightmare, 2)}')
    elif v == 'Pig':
        print(f'Add-ons: {random.sample(Pig, 2)}')
    elif v == 'Clown':
        print(f'Add-ons: {random.sample(Clown, 2)}')
    elif v == 'Spirit':
        print(f'Add-ons: {random.sample(Spirit, 2)}')
    elif v == 'Legion':
        print(f'Add-ons: {random.sample(Legion, 2)}')
    elif v == 'Plague':
        print(f'Add-ons: {random.sample(Plague, 2)}')
    elif v == 'Ghost Face':
        print(f'Add-ons: {random.sample(Ghost_Face, 2)}')
    elif v == 'Demogorgon':
        print(f'Add-ons: {random.sample(Demogorgon, 2)}')
    elif v == 'Oni':
        print(f'Add-ons: {random.sample(Oni, 2)}')
    elif v == 'Deathslinger':
        print(f'Add-ons: {random.sample(Deathslinger, 2)}')
    elif v == 'Cannibal':
        print(f'Add-ons: {random.sample(Cannibal, 2)}')
    elif v == 'Executioner':
        print(f'Add-ons: {random.sample(Executioner, 2)}')
    elif v == 'Hillbilly':
        print(f'Add-ons: {random.sample(Hillbilly, 2)}')
    elif v == 'Blight':
        print(f'Add-ons: {random.sample(Blight, 2)}')
    elif v == 'Twins':
        print(f'Add-ons: {random.sample(Twins, 2)}')
    elif v == 'Trickster':
        print(f'Add-ons: {random.sample(Trickster, 2)}')
    elif v == 'Nemesis':
        print(f'Add-ons: {random.sample(Nemesis, 2)}')
    elif v == 'Cenobite':
        print(f'Add-ons: {random.sample(Cenobite, 2)}')
    elif v == 'Artist':
        print(f'Add-ons: {random.sample(Artist, 2)}')
    elif v == 'Onryō':
        print(f'Add-ons: {random.sample(Onryō, 2)}')
    elif v == 'Dredge':
        print(f'Add-ons: {random.sample(Dredge, 2)}')
    elif v == 'Mastermind':
        print(f'Add-ons: {random.sample(Mastermind, 2)}')
    elif v == 'Knight':
        print(f'Add-ons: {random.sample(Knight, 2)}')
    elif v == 'Skull Merchant':
        print(f'Add-ons: {random.sample(Skull_Merchant, 2)}')
    elif v == 'Singularity':
        print(f'Add-ons: {random.sample(Singularity, 2)}')
    elif v == 'Xenomorph':
        print(f'Add-ons: {random.sample(Xenomorph, 2)}')
    else:
